                ...
                <div className="collapse navbar-collapse" id="navbarPortfolio" >
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-end w-100">
                        <li className="nav-item">
                            <Link className="nav-link text-effect" to="section-profile" smooth={true} offset={0} duration={100} >
                                {t('Navbar.Profile')}
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link text-effect" to="section-technologies" smooth={true} offset={-200} duration={100} >
                                {t('Navbar.Technologies')}
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link text-effect" to="section-experience" smooth={true} offset={-200} duration={100} >
                                {t('Navbar.Experience')}
                            </Link>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link text-effect" to="section-contact" smooth={true} offset={-100} duration={100} >
                                {t('Navbar.Contact')}
                            </Link>
                        </li>
                    </ul>
